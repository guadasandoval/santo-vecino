...
getBookingbyId(id: string): Observable<BookingModel> {
  return this.http.get<BookingModel>(`${this.BASE_URL}/booking-details/${id}`)
}

updateBooking(id:string, booking:any): Observable<ServerResponse>{
  return this.http.put<ServerResponse>(`${this.BASE_URL}/booking-details/${id}`, booking)
}
cancelBooking(id:string): Observable<ServerResponse> {
  return this.http.delete<ServerResponse>(`${this.BASE_URL}/booking-details/${id}`)
}
}
